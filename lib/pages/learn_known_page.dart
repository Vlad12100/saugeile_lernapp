...
class LearnKnownPage extends StatefulWidget {
  const LearnKnownPage({Key? key}) : super(key: key);

  @override
  State<LearnKnownPage> createState() => _LearnKnownPageState();
}

class _LearnKnownPageState extends State<LearnKnownPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Wiederholung 🐷", style: TextStyle(fontSize: 25)),
      ),
      body: Padding(
        padding: const EdgeInsets.all(0),
        child: StreamBuilder(
          stream: getWordsForKnown(),
